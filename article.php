...
<a href="#top" id="back-to-top" class="arrow-up"><i class="fas fa-arrow-up fa-2x "></i></a>
    ...
    <div class="gabarit">
        ...
        <nav id="primary-nav">
            <ul>
                ...
                <li><a href="panier.html">Panier <span class="nbre-produits"></span></a> </li>
            </ul>
        </nav>
     </div>
    ...
    <main>
        <h2>Le Blog</h2>
            <article>
                ...
                <div>
                    <figure>
                        <img src="img/blog/article-01-big.jpg" alt="description de l'image">
                        <figcaption>Légende de l'image</figcaption>
                    </figure>
                    <div>
                        <p>
                            Lorem Ipsum est simplement un texte factice de l'industrie de l'impression et de la composition. <br>
                        ...
                        <footer>Auteur: PatK | Date: 09/03/2021</footer>
                    </div>
                </div>
            </article>
        </section>
...
<footer>
    ...
    <p>&copy; 2021 tous droits de reproductions réservés</p>
</footer>
